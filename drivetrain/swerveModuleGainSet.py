...
class SwerveModuleGainSet:
    ...
    def __init__(self,module:str=""):
        ...
        self.wheelS = Calibration(module + "Drivetrain Module Wheel kS", 0.15, "volts")
        self.azmthP = Calibration(module + "Drivetrain Module Azmth kP", 0.03)
        self.azmthI = Calibration(module + "Drivetrain Module Azmth kI", 0.0)
        self.azmthD = Calibration(module + "Drivetrain Module Azmth kD", 0.0000)
