...
class CCycleL1(Mode):
    def __init__(self):
        ...
        self.pathCmd1 = DrivePathCommand("GatherR1")
        self.pathCmd2 = DrivePathCommand("GatherR2")
        self.pathCmd3 = DrivePathCommand("GatherR3")
        self.pathCmd4 = DrivePathCommand("GatherR4")
