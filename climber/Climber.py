     ...
     def startClimb(self):
         ...
         match self.step:
             ...
             case ClimberSteps.STEP4_LEFTHOOK_BACK_DOWN:
                 # step 4: left hook goes back down#                 self.lefthook_motor.setPosCmd(3)
                 self.righthook_motor.setPosCmd(3)
             ...
             case ClimberSteps.STEP5_CLIMB_DOWN:
                 ...
                 if (self.lefthook_motor.getMotorPositionRad() <= 0 and self.righthook_motor.getMotorPositionRad() <= 0):                
                     self.setStep(ClimberSteps.STEP0_IDLE)
                     #end of normal climb.
                     # step 6: auto climb, it will be used on its own and not with the other steps.#             case ClimberSteps.STEP6_AUTO_CLIMB:
                 self.lefthook_motor.setPosCmd(3)
